RSpec.describe KcSdkApp::Api::Orders do
  describe '#surplus' do
    let(:url) { 'https://cloud.kabob.io/api/app/v1/orders/surplus' }
    ...
    context 'when params is ok' do
      ...
      after do
        KcSdkApp::Api.new.orders.surplus(params)
      end
    ...
    context 'when leak of required params' do
      ...
      it { expect { KcSdkApp::Api.new.orders.surplus(params) }.to raise_error(ArgumentError, message) }
    end
  end

  describe '#consuming' do
    let(:url) { 'https://cloud.kabob.io/api/app/v1/orders/consuming' }
    ...
    context 'when params is ok' do
      ...
      after do
        KcSdkApp::Api.new.orders.consuming(params)
      end
    ...
    context 'when leak of required params' do
      ...
      it { expect { KcSdkApp::Api.new.orders.consuming(params) }.to raise_error(ArgumentError, message) }
    end
  end
end
